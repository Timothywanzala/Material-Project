...
import { dashboardStats } from 'src/_mock/dashboard';
// import AppTasks from '../app-tasks';
// import AppNewsUpdate from '../app-news-update';
// import AppOrderTimeline from '../app-order-timeline';
import AppCurrentVisits from '../app-member';
      ...
      <Grid container spacing={3}>
        <Grid xs={12} sm={6} md={3}>
          <AppWidgetSummary
            ...
            total={dashboardStats.totalParticipants}
            color="success"
        ...
        <Grid xs={12} md={6} lg={8}>
          <AppWebsiteVisits
            ...
            chart={{
              labels: dashboardStats.dashboardLabels,
              series: [
                {
